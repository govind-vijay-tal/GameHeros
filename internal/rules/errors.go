...
var (
	...
	ErrMatchNotLive          = errors.New("match is not live. Start the match first")
	ErrMatchNotScheduled     = errors.New("only scheduled matches can be edited or deleted")
	ErrDuplicatePlayer       = errors.New("player with this name already exists in the team")
	ErrPlayerNotFound        = errors.New("player not found")
	ErrInvalidRole           = errors.New("invalid role for the selected sport type")
	...
	ErrPlayerAlreadyInTeam   = errors.New("player is already in this team for this tournament")
	ErrPlayerInDifferentTeam = errors.New("player is already in a different team for this tournament")
	ErrTournamentConfigLocked = errors.New("tournament configuration is locked because matches have been scheduled")
	ErrInvalidConfig          = errors.New("invalid tournament configuration")
	ErrInsufficientPlayers    = errors.New("teams do not have the required number of players as per tournament configuration")
)
